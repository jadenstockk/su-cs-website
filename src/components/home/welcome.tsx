...
export default function Welcome() {
  ...
  return (
    <section className="relative z-10 -mt-5 bg-primary rounded-t-4xl pt-20 pb-10">
      <ContentContainer className="pb-10">
        ...
        >
          ...
          {/* Photo side */}
          <div className="relative w-full overflow-hidden rounded-2xl md:w-[42%] aspect-16/10 md:aspect-auto md:min-h-65">
            <Image
