...
export default function Postgraduate() {
  const t = useTranslations("Postgraduate");

  return (
    <section className="relative z-10 bg-primary pt-20 pb-10">
      <ContentContainer className="pb-10">
        <motion.div
          ...
          className="flex flex-col-reverse items-center gap-8 md:flex-row md:items-stretch md:gap-12"
        >
          {/* Text side */}
          ...
          {/* Photo side */}
          <div className="relative w-full overflow-hidden rounded-2xl md:order-2 md:w-[42%] aspect-16/10 md:aspect-auto md:min-h-65">
            <Image
              src="/assets/images/scenes/comp-sci-lecture.webp"
              alt="Postgraduate Computer Science students at Stellenbosch University"
              fill
